...
export const appSlice = createSlice({
  ...
  reducers: (create) => ({
    ...
    setCaptcha: create.reducer<{ captchaUrl: string }>((state, action) => {
...
export const { changeThemeMode, setAppStatus, setAppError, setIsLoggedIn, setCaptcha } = appSlice.actions
